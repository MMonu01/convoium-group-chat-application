...
const ChatList = ({ room, ...props }) => {
  ...
  return (
    <>
      <div className={`w-full p-4 hover:bg-black flex gap-3 items-center ${props.current_room.room_id === room.room_id ? "bg-black" : ""}`}>
        <div>
